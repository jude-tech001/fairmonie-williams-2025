    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-sm mx-auto p-0 bg-background rounded-3xl overflow-hidden border-0 shadow-2xl max-h-[480px]">
        ...
        <div className="p-5 text-center">
          ...
          {/* Title */}
          <h2 className="text-lg font-bold text-foreground mb-2">Earn ₦6,500!</h2>
          ...
          <Button
            ...
            className="w-full bg-primary hover:bg-primary/90 text-primary-foreground py-2.5 rounded-full font-medium text-sm mb-3 transition-all duration-200 transform hover:scale-105"
          >
            <svg 
