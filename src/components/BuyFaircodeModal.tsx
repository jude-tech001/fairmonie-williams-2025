...
const BuyFaircodeModal: React.FC<BuyFaircodeModalProps> = ({ onBack, user }) => {
  ...
  const handleCopyAccountNumber = () => {
    enableSpeech();
    navigator.clipboard.writeText('9164234650').then(() => {
      toast({
        title: "Copied!",
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center p-2 bg-green-50 rounded">
                    <div>
                      ...
                      <p className="font-semibold text-sm">9164234650</p>
                    </div>
                    <button
                  ...
                  <div className="flex justify-between items-center p-2 bg-green-50 rounded">
                    <div>
                      ...
                      <p className="font-semibold text-sm">BANKIT MFB BANK</p>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between items-center p-2 bg-green-50 rounded">
                    <div>
                      ...
                      <p className="font-semibold text-sm">CHIDERA  OKORIE</p>
                    </div>
                  </div>
                </div>
